...
LLM_PROD_MODEL = os.getenv("LLM_PROD_MODEL")
LLM_TEST_MODEL = os.getenv("LLM_TEST_MODEL")

def query_LLM(instructions: str, user_data: str, model: str = "claude-v4.6-sonnet") -> str:
    """
    Sends a structured prompt to the UCSB AI Commons API.
    ...
    # We override the default OpenAI base URL with the AI Commons URL
    client = OpenAI(
...
# Only runs if you execute this file directly (e.g., `python ai_commons.py`)
# ---------------------------------------------------------
if __name__ == "__main__":
    print("--- Testing UCSB AI Commons Module ---")
    ...
    if not base_url or not api_key:
        ...
        print("Please set LLM_API_BASE and LLM_API_KEY in your environment.")
        exit(1)
